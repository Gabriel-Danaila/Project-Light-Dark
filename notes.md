light/dark togle with 3 stages : https://codepen.io/renddrew/pen/bRomab ( befault = system preference iar light/dark overwrite system preference )

use js to update the css variable: https://css-tricks.com/updating-a-css-variable-with-javascrip

prefers clor scheme media query: https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-color-scheme

accessibility - use corect tags for headings and for screanreadears-only for card titles/names: https://www.accessibility-developer-guide.com/examples/hiding-elements/visually/
